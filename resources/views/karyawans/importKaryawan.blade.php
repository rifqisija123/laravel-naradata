...
@section('importExcel')
    <div class="container mt-4">
        <h4 class="mb-4 fw-semibold">Import Karyawan</h4>

        <div class="card shadow-sm">
            <div class="card-header bg-white border-bottom">
                <h5 class="mb-0"><i class="fa-solid fa-file-import me-2 text-primary"></i>Import Data Karyawan</h5>
            </div>
                ...
                <div class="col-md-6">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <ol class="ps-3">
                            ...
                            <li>Klik tombol "Import Karyawan" untuk memulai proses import.</li>
                        </ol>
                        <a href="{{ asset('template/DataKaryawan.xlsx') }}" class="btn btn-outline-primary mt-2">
                    ...
                    <div class="p-3 border rounded bg-light">
                        <form method="POST" action="{{ route('import.karyawan') }}" enctype="multipart/form-data"
                            ...
                            <button type="button" class="btn btn-primary w-100" id="btnImport"
                                ...
                                <i class="fa-solid fa-cloud-arrow-up me-1"></i>Import Karyawan
                            </button>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-12 d-flex justify-content-end my-5">
            <a href="{{ route('karyawan.index') }}" class="btn btn-secondary mt-4">
