...
@section('importExcel')
    <div class="container mt-4">
        <h4 class="mb-4 fw-semibold">Import Ruangan</h4>

        <div class="card shadow-sm">
            <div class="card-header bg-white border-bottom">
                <h5 class="mb-0"><i class="fa-solid fa-file-import me-2 text-primary"></i>Import Data Ruangan</h5>
            </div>
            ...
            <div class="card-body row g-4">
                ...
                <div class="col-md-6">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <ol class="ps-3">
                            ...
                            <li>Klik tombol "Import Ruangan" untuk memulai proses import.</li>
                        </ol>
                        <a href="{{ asset('template/DataRuangan.xlsx') }}" class="btn btn-outline-primary mt-2">
                ...
                <div class="col-md-6">
                    <div class="p-3 border rounded bg-light">
                        <form method="POST" action="{{ route('import.lokasi') }}" enctype="multipart/form-data"
                            id="formImport">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-primary w-100" id="btnImport"
                                ...
                                <i class="fa-solid fa-cloud-arrow-up me-1"></i>Import Ruangan
                            </button>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-12 d-flex justify-content-end my-5">
            <a href="{{ route('lokasi.index') }}" class="btn btn-secondary mt-4">
