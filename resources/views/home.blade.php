            ...
            <div class="container mb-5 d-flex justify-content-end">
                <div class="card shadow-sm border-0 rounded-4 p-4" style="max-width: 450px; width: 100%;">
                    ...
                    <div class="row g-2 mb-3" id="faq-buttons">
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="tambahBarang">➕ Tambah
                                Barang</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="tambahUser">👤 Tambah
                                Karyawan</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="logAktivitas">📜
                                Aktivitas</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="hapusBarang">🗑️ Hapus
                                Barang</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="barangHilang">🔍 Barang Tidak
                                Muncul</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-outline-primary w-100 btn-sm" data-faq="ubahBarang">✏️ Ubah Data
                                Barang</button>
                        </div>
                    </div>
