<div class="d-flex justify-content-between align-items-center mb-3 mt-5">
    <h5 class="mb-0 fw-semibold">Daftar Riwayat Peminjaman</h5>
    <div>
...
<div class="card shadow-sm border-1 rounded-3">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered align-middle" id="tbl_riwayat_peminjaman">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center">Tidak ada data Riwayat Peminjaman</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
